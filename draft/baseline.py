...
#The goal is to do neuroevolution can import DEAP or other libraries for EA

# Explain the EA in the report
# Plot fitness over time with experiments with standard deviation and mean lines
# Comparative Analysis of 2 experiments on top of Baseline experiment- compare and draw conclusions
# Compare EA(weight/ architecture), fitness function, environment
#test the baseline and the main experiments and show the differences/improvements in each.
#Repeat each experiment a minimum of 3 times, plot the results together to show any statistical significance

# 9 Runs, 3 Line plots

#Deliverables(zip): 1. Report, 2. Code, 3. a file with the controller of your best-performing experiment for your chosen
#environment and task (such that we can reproduce your results) 
